<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="reopencomplaint.aspx.cs" CodeFile="reopencomplaint.aspx.cs" Inherits="AMC_EGRS.admin.WebForm13" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" CssClass="table table-condensed table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="cid" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand">
        <Columns>
            ...
            <asp:BoundField DataField="creopen" HeaderText="creopen" SortExpression="creopen" />
            <asp:BoundField DataField="cstatus" HeaderText="cstatus" SortExpression="cstatus" />
            <asp:TemplateField HeaderText="ACTION">
                <ItemTemplate>
                    <asp:Button ID="btnsolved2" runat="server" CommandArgument='<%#Eval("cid") %>' CssClass="btn btn-danger" Text="Approved"/>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AMC_COMPLAINConnectionString %>" SelectCommand="SELECT * FROM [complaint_master] WHERE (([cstatus] = @cstatus) OR ([cstatus] = @cstatus2))">
        <SelectParameters>
            <asp:Parameter DefaultValue="RE-OPEN" Name="cstatus" Type="String" />
            <asp:Parameter DefaultValue="RE_OPEN" Name="cstatus2" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
