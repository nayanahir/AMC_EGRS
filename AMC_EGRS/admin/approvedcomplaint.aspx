<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="approvedcomplaint.aspx.cs" CodeFile="approvedcomplaint.aspx.cs" Inherits="AMC_EGRS.admin.WebForm22" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12  col-12">
                <div class="float-right m-b-10">
                    <a href="reopencomplaint.aspx" class="btn btn-success"><i class="ti-check-box"></i>&nbsp;RE-OPENED Complaint</a>
                    <a href="solvedcomplaint.aspx" class="btn btn-primary"><i class="fa fa-rocket"></i>&nbsp;Solved Complete</a>
    ...
    <%-- grid view start --%>
    <asp:GridView CssClass="table table-condensed table-hover" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cid" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand">
        <Columns>
            ...
            <asp:TemplateField HeaderText="ACTION">
                            <ItemTemplate>
                                <asp:Button ID="btnsolved" runat="server" CommandArgument='<%#Eval("cid") %>' CssClass="btn btn-danger" Text="Solved"  />
                            </ItemTemplate>
                        </asp:TemplateField>
        </Columns>
    </asp:GridView>
